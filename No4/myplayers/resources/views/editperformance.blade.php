...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/editperformance.css') }}">
</head>
<body>
    <h1>成績編集</h1>
    <form action="{{ route('performances.confirm') }}" method="post">
        @csrf
        @if(isset($inputs))
        <input type="hidden" name="id" id="id" value="{{ $inputs['id'] }}" required>
        @else
        <input type="hidden" name="id" id="id" value="{{ $performance['id'] }}">
        @endif

        @if(isset($inputs))
        <input type="hidden" name="player_id" id="player_id" value="{{ $inputs['player_id'] }}" required>
        @else
        <input type="hidden" name="player_id" id="player_id" value="{{ $performance['player_id'] }}">
        @endif
        ...
        @else
        <input type="date" name="game_date" id="game_date" value={{ $performance['game_date'] }} required><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="at_bat" id="at_bat" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['at_bat'] }} ><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="single" id="single" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['single'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="double" id="double" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['double'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="triple" id="triple" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['triple'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="homerun" id="homerun" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['homerun'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="strikeout" id="strikeout" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['strikeout'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="walk" id="walk" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['walk'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="hit_by_pitch" id="hit_by_pitch" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['hit_by_pitch'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="steal" id="steal" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['steal'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="sacrifice_bunt" id="sacrifice_bunt" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['sacrifice_bunt'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="sacrifice_fly" id="sacrifice_fly" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['sacrifice_fly'] }}><br>
        @endif
        ...
        @else
        <input type="text" maxlength="11" name="rbi" id="rbi" pattern="^[0-9]+$" placeholder="数値のみ入力できます" value={{ $performance['rbi'] }}><br>
        @endif
        
        @if(isset($inputs))
        <a href="{{ route('players.detail', $inputs['player_id']) }}" class=>選手詳細へ戻る</a>
        @else
        <a href="{{ route('players.detail', $performance['player_id']) }}" class=>選手詳細へ戻る</a>
        @endif
